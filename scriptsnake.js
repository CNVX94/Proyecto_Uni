...
const iniciarJuego = () => {
    ...
    let html = `<div class="comida" style="grid-area: ${comidaY} / ${comidaX}"><img src="./imgsnake/dulce.png" alt="dulce"></div>`;
    ...
    if(cabezaX <= 0 || cabezaX > 30 || cabezaY <= 0 || cabezaY > 30){
     ...
     for (let i = 0; i < cuerpoSerpiente.length; i++) {
        html += `<div class="comida" style="grid-area: ${cuerpoSerpiente[i][1]} / ${cuerpoSerpiente[i][0]}"><img src="./imgsnake/ojo.png" alt="ojo"></div>`;
...
actualizarPosicionComida();
intervalodsId = setInterval (iniciarJuego, 100);
